...
The next step is to create the token co-occurrence matix (TCM).  The definition of whether two words occur together is arbitrary.  Should we just look at previous and next word? Five behind and forward?  This will definitely affect results so you will want to play around with it.
...
test = shakes_word_vectors["italy", , drop = F] -
