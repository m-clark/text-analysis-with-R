...
```{r regex_intro_ex}
grepl(c('r is the shiny1', 'r shines brightly'), pattern='^r(.)*shiny[0-9]$')
```

What the regex esotericly is attempting to match is any string  that starts with 'r' and ends with 'shiny_' where _ is some single digit.  None of it makes sense
