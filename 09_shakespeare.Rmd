...
topic_class %>%
  ...
  heatmaply::heatmaply(Rowv=NA,
                       ...
                       column_text_angle=0, 
                       colors=colorRampPalette(c('white', palettes$tyrian_purple2$tyrian_purple)),
                       # subplot_widths=c(1),
                       plot_method = 'plotly',
                       fontsize_row=8,
                       fontsize_col=8,
