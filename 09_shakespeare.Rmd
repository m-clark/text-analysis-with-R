...
We are finally ready to get to the fun stuff.  We can get term counts with standard <span class="pack">dplyr</span> approaches, and <span class="pack">tidytext</span> will take that and do the other things we might want. With word counts in hand, now would be a good save point.

```{r term_counts, results='hold'}
...
Now we're looking like Shakespeare, with love for everyone.  Love might as well be a stopword for Shakespere.  You'll notice I've kept place names such as Rome, but this might be something you'd prefer to remove.  Other candidates would be madam, woman, man, majesty (as in 'his/her') etc.
