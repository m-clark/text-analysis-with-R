...
<iframe src="vis/index.html" width="100%" height="850px" frameborder="0"
    scrolling="yes"
    marginheight="0"
    marginwidth="0">
...
```{r cluster_topics, echo=FALSE, fig.align='center', fig.width=11, fig.height=5, out.height='800px', out.width='650px'}
