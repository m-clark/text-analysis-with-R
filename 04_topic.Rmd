...
# summary jhfc!
# you can't use width and height except with heatmapr (layout() from plotly is deprecated or otherwise would be an option)
# row_side_colors needed in heatmapr, but it can't be the factor label itself, or it will give an error
# wtf knows what row_side palette is for
...
fix_heatmaply = shakes_10@gamma %>%
  ...
  heatmaply::heatmapr(Rowv=row_dend,
           ...
           k_row = 4,
           row_side_colors = data.frame(class= c(palettes$orange$orange, palettes$orange$tetradic)[as.integer(factor(shakes_types$class))]),
...
heatmaply::heatmaply(fix_heatmaply,
                     ...
                     colors='Oranges',
                     plot_method = 'plotly',
                     row_side_colors = c(palettes$orange$orange, palettes$orange$tetradic)[as.integer(factor(shakes_types$class))],
                     row_side_palette = 'wtf ever you want',
                     RowSideColors = 'wtf ever you want',
                     label_names = c('row', '2'),
                     grid_gap=5,
                     hide_colorbar = T,
                     colorbar_len = 0.3,
