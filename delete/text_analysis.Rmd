...
I'd say we're now ready for topic model.  We'll run a topic model and see how things shake out with 10 topics.  We can also see how things compare with the usual classifications for the texts.

```{r topic_model, echo=1:2, eval=1:2}
library(topicmodels)
