...
In addition, the lexicons are going to maybe be applicable to *general* usage of English in the western world.  o some might
...
[^tidytext]: To be perfectly honest, I found the tidytext/purrr approach to be nonintuitive and even not useable for text that was not already in a nice state.  I suggest if you have to do actual processing with messy, i.e. typical, text, stick with <span class="pack">tm</span> and related.
